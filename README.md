...
Once the `conda-forge` channel has been enabled, `qsymm` can be installed with:

```
conda install qsymm
```

It is possible to list all of the versions of `qsymm` available on your platform with:
